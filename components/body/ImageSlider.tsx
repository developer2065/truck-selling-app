...
const ImageSlider = () => {
  ...
  const animateSingleBar = (index: number) => {
    ...
    // صفرش کن
    gsap.set(progressRefs.current[index], { width: '0%', backgroundColor: progressBarColor })
            ...
            <div className={styles.imageWrapper}>
              ...
              {index === 0 && (
                <div className={styles.overlayContent1}>
                  ...
                  <a href="/products" className={styles.ctaButton}>دریافت اطلاعات</a>
                </div>
              )}     
      {index === 1 && (
        <div className={styles.overlayContent2}>
          ...
          <a href="/media" className={styles.ctaButtonAlt}>شروع بررسی</a>
        </div>
      )}
            </div>
          </SwiperSlide>
